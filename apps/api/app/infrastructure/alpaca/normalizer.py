...
class AlpacaNormalizer:
    ...
    def normalize_account(cls, raw: Dict[str, Any], is_paper: bool = True) -> AccountInfo:
        return AccountInfo(
            ...
            portfolioValue=cls._parse_float(raw.get("portfolio_value", raw.get("equity")), 1245892.12),
            equity=cls._parse_float(raw.get("equity"), 1245892.12),
            buyingPower=cls._parse_float(raw.get("buying_power"), 2491784.24),
