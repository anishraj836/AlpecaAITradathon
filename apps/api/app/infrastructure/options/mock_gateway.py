...
class MockOptionsIntelligenceGateway(OptionsIntelligenceGateway):
    ...
    async def stress_test(self, strategy_id: str = "strat-condor-01") -> StressReport:
        return StressReport(
            ...
            matrix=[
                StressMatrixCell(priceShiftPct=3.0, ivShiftPct=-20.0, pnl=-4210.0),
                StressMatrixCell(priceShiftPct=3.0, ivShiftPct=0.0, pnl=-5890.0),
                StressMatrixCell(priceShiftPct=3.0, ivShiftPct=20.0, pnl=-8120.0),
                StressMatrixCell(priceShiftPct=1.5, ivShiftPct=-20.0, pnl=2150.0),
                StressMatrixCell(priceShiftPct=1.5, ivShiftPct=0.0, pnl=-850.0),
                StressMatrixCell(priceShiftPct=1.5, ivShiftPct=20.0, pnl=-2400.0),
                StressMatrixCell(priceShiftPct=0.0, ivShiftPct=-20.0, pnl=8420.0),
                StressMatrixCell(priceShiftPct=0.0, ivShiftPct=0.0, pnl=6100.0),
                StressMatrixCell(priceShiftPct=0.0, ivShiftPct=20.0, pnl=3250.0),
                StressMatrixCell(priceShiftPct=-1.5, ivShiftPct=-20.0, pnl=9150.0),
                StressMatrixCell(priceShiftPct=-1.5, ivShiftPct=0.0, pnl=7800.0),
                StressMatrixCell(priceShiftPct=-1.5, ivShiftPct=20.0, pnl=4920.0),
                StressMatrixCell(priceShiftPct=-3.0, ivShiftPct=-20.0, pnl=-1250.0),
                StressMatrixCell(priceShiftPct=-3.0, ivShiftPct=0.0, pnl=-3400.0),
                StressMatrixCell(priceShiftPct=-3.0, ivShiftPct=20.0, pnl=-6180.0),
            ],
        )
